<%-- 
    ...
    Created on : Jun 9, 2023, 9:33:52 PM
    Author     : Danh
--%>
...
<div>
    <ul class="nav nav-tabs justify-content-end" style="margin-bottom: 5px;">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="<c:url value="/humanResource/employeeManagement.do"/>">Quản lý nhân viên</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" aria-current="page" href="<c:url value="/humanResource/index.do"/>" >Kích hoạt tài khoản</a>
        </li>
    </ul>
    <form action="<c:url value="/humanResource/employeeManagement.do"/>">
            ...
            <tr>
                ...
                <td style="text-align: end;">
                    <a class="btn btn-secondary" style="width: 120px" 
                       href="<c:url value="/humanResource/detail.do?empId=${employee.id}&actionPre=employeeManagement"/>">
                    ...
                    <a class="btn btn-secondary" style="width: 120px" 
                       href="<c:url value="/humanResource/update.do?empId=${employee.id}&actionPre=employeeManagement"/>">
...
<script>
    function confirmDeactivation(accountId,accountName ) {
        ...
        if (result) {
            window.location.href = "<c:url value='/humanResource/deactivate.do?accId=' />" + accountId + "&actionPre=employeeManagement";
        }
        return false;
    }
    function reload() {
